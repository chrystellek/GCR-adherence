...
# TODO add urban/rural to list/table, add to paragraph
...
Our study population consisted of `r formatC(pop_info$total_study, big.mark = ",")` eligible patients who had at least one prescription for AI or tamoxifen between January 1, 2018 and December 31, 2021. There are `r formatC(raceeth$n_white, big.mark = ",")` patients of White race, `r formatC(raceeth$n_blackAA, big.mark = ",")` Black or African American, `r formatC(raceeth$n_asian, big.mark = ",")` Asian, `r formatC(raceeth$n_oth_unk, big.mark = ",")` who were of Alaskan Native, American Indian, other, or unknown race, and of `r formatC(raceeth$n_hispanic, big.mark = ",")` Hispanic ethnicity.
...
```
  ...
  In our ITS regression analyses, there was a slight decrease in the proportion of patients who were adherence before the pandemic (−0.2%, 95% CI -0.3%, -0.06%), suggestion of slight increase in adherence at the time of the pandemic (1.2%, 95% CI -5.5%, 9.1%) and no linear change in adherence in the years during the pandemic (0.04%, 95% CI -0.2%, 0.3%). These estimates suggest no linear change in adherence due to COVID. This is plotted in Figure X above.  

  We repeated this among demographic subgroups of interest, by race/ethnicity and by county-level urbanicity (at time of diagnosis).
...
```
  ...
  By race/ethnicity, adherence appears to have greater range among NH White and NH Black or AA patients, and for both, sudden increase due to pandemic but decrease afterward.
...
There are some of time periods where there are no patients in rural counties who are taking medication. 
...
#TODO add persistence/ discontunuous
